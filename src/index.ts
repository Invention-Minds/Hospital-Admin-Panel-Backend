...
app.use(cors({
  origin: ['http://localhost:4200','https://rashtrotthanahosptial.netlify.app/', 'https://hosptial-admin-panel.netlify.app/','http://localhost:58664/','https://www.rashtrotthanahospital.com/','http://localhost:63904/'], 
  methods: ['GET', 'POST'],
  credentials: true
}));
