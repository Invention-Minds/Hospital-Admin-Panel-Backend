...
import patientPortalRoutes from './api/patient-portal/patient-portal.routes';
...
import ophthalmologyRoutes from './api/ophthalmology/ophthalmology.routes';
...
// Public, token-authenticated patient record view (expiring links from the bot).
app.use('/p', patientPortalRoutes);
