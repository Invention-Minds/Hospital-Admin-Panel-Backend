  ...
  try {
    ...
    for (const service of servicesWithRepeats) {
      ...
      try {
        ...
        let patient_message = "";
        patient_message = `Namaste ${patientName}, Your ${packageName} package is ${status} for ${appointmentDate} at ${appointmentTime}. Kindly note that there is a standard Turnaround Time (TAT) for all investigation reports. We appreciate your patience and recommend consulting your doctor once the reports are ready. For any assistance, please contact 080 6923 9999. Thank You! Regards, Team Rashtrotthana	`;
