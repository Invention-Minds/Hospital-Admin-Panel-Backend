      ...
      if (appointment) {
        ...
        try {
          ...
          if (success === 'true') {
            ...
            let success_message = `Thank you for visiting Rashtrotthana Hospital! We appreciate your trust in us. Please contact 080 6923 9999 for further assistance. Wishing you good health! Regards, Team Rashtrotthana`;
