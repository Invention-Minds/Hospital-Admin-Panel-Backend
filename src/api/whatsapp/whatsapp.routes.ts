...
import {  checkAndSendReminders,CornSchedular,markComplete,remainderForAdmin,reminderForServices,sendAdminMessage,sendDoctorMessage,sendServiceWhatsappMessage,sendWhatsAppChatbot,sendWhatsAppMessage } from './whatsapp.controller'; // Ensure this path is correct
...
router.post('/remainder', markComplete );
