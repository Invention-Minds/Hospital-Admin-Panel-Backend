...
exports.getAvailableDoctorsCount = exports.getAvailableDoctors = exports.getUnavailableDates = exports.addUnavailableDates = exports.getBookedSlots = exports.addBookedSlot = exports.getDoctorAvailability = exports.deleteDoctor = exports.updateDoctor = exports.getDoctorById = exports.getDoctors = exports.createDoctor = void 0;
...
const deleteDoctor = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield prisma.bookedSlot.deleteMany({
            where: { doctorId },
        });
...
const addUnavailableDates = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.addUnavailableDates = addUnavailableDates;
...
const getUnavailableDates = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const unavailableDates = yield prisma.unavailableDates.findMany({
            where: {
                doctorId: Number(doctorId),
            },
            select: {
...
const getAvailableDoctors = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const availableDoctors = yield resolver.getAvailableDoctors(date);
...
const getAvailableDoctorsCount = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { date } = req.query;
        if (!date) {
            res.status(400).json({ error: 'Date is required' });
        ...
        const count = yield resolver.getAvailableDoctorsCount(date);
...
exports.getAvailableDoctorsCount = getAvailableDoctorsCount;
